...
from packets_tacker import PacketsTracker
...
class SimplePacketsTracker(PacketsTracker):
    MAX_IDLE_TIME = 30
    ...
    def find_and_remove_dead_connections(self, current_time):
        ...
        for k, v in self.__active_connections_map.items():
            if current_time - v.last_packet_timestamp > SimplePacketsTracker.MAX_IDLE_TIME:
        ...
        print("tacker: closed connections: " + str(len(self.__closed_connections_map)))
