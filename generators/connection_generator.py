...
class ConnectionGenerator:
    ...
    def generate(self):
        self.__start_time += numpy.random.exponential(1 / self.__connection_establishment_parameter)
        end_time = self.__start_time + numpy.random.exponential(1 / self.__connection_life_time_parameter)
